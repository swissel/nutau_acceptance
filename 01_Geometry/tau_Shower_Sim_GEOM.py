...
if __name__ == "__main__":
  ...
  A0 = 2.*pi**2 * Earth_radius * args.altitude / (1. +  args.altitude / Earth_radius )
  print 'A0', A0, 'km^2 sr'

  ev_count = 0
  dat = GEOM(args.altitude, args.num_events, view_angle_cut_deg = args.theta_view_cut)
  dat = np.array(dat)
  ...
  while(ev_count < args.target_num_events):
    ...
    out = GEOM(args.altitude, args.num_events, view_angle_cut_deg = args.theta_view_cut)
    out = np.array(out)
